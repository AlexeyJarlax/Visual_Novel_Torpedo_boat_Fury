    ...
    internal val dialogues: List<Pair<Int, Dialogue>> = listOf(
        ...
        119 to Dialogue(
            text = "Наши корабли приближались к гавани Виго. Мы встретили прекрасную бухту, утопающую " +
                    ...
                    "горами. Побережье украшали небольшие рыбацкие деревни. С нашего прибытия салютом " +
                    "почтили испанский флаг, и мы направились к центру города, где сразу же бросили " +
