    ...
    internal val dialogues: List<Pair<Int, Dialogue>> = listOf(
        ...
        65 to Dialogue(
            text = "Один из прожекторов неожиданно нарыскал небольшой корабль, наблюдатель тут же передал по связи, что видит неизвестный миноносец. В связи с тем, что наши миноносцы " +
                    "позади, делаю вывод, что корабль не может быть нашим. Пытаюсь определить корабль по силуету в штормовом море и под светом прожекторов, но мне не удается",
            scene = scenes[5],
            options = listOf(
                Option(
                    text = attack,
        ...
        66 to Dialogue(
            text = "Взрыв торпеды осветил яркой вспышкой кусочек моря, и нашу цель, которая внезапно оказалась вовсе не миноносцем... Мы подошли ближе и я дал распоряжение " +
                    "спасательной команде вылавливать людей - матросы и рыбаки прыгали с горящего корабля в воду, кто-то на параходе пытался спустить шлюпку, но их судно " +
                    "очень быстро тонуло...",
            scene = scenes[5],
            options = listOf(
                Option(
                    text = "Чтож... Плохая извесность - это тоже известность. Жаль боезопас потратили на рыбаков",
