    ...
    internal val dialogues: List<Pair<Int, Dialogue>> = listOf(
        ...
        63 to Dialogue(
            text = "После указания двигаться во французский портовый город Брест других приказов миноносцам от адмирала не поступало... " +
                    "Я дал приказ развернуть корабль к флотлии, а наблюдателям рыскать прожекторами... ",
            scene = scenes[5],
            options = listOf()
        ),
        ...
        64 to Dialogue(
            text = "Далее началась просто невообразимая суматоха: Телеграф сообщал, что СУВОРОВ включил боевые огни, его примеру последовали остальные корабли. Тут же часть кораблей начала " +
                    "сообщаять по телеграфу об обнаружении противника. Поступил приказ от адмирала открыть огонь. И я наконец услышал отдаленный рокот орудий главного калибра.  Мой миноносец " +
        ...
        65 to Dialogue(
            text = "Один из прожекторов неожиданно подсветил небольшой корабль, и наблюдатель тут же передает по связи, что видит неизвестный миноносец. В связи с тем, что наши миноносцы были " +
                    "все позади, этот корабль не мог быть нашим. В такой темноте определить по силуету тип корабля мне не удается",
            scene = scenes[5],
            options = listOf(
                Option(
                    text = attack,
        ...
        67 to Dialogue(
            text = "Взрыв торпеды осветил яркой вспышкей кусочек моря, и нашу цель, которая внезапно оказалась вовсе не миноносцем... Мы подошли ближе и я дал распоряжение" +
                    "спасательной команде вылавливать людей, которые уже прыгали в воду с тонущего рыбацкого парахода...",
            scene = scenes[5],
            options = listOf()
        ),

        68 to Dialogue(
            text = "Рокот орудий был слышен из далека. Суматоха боя наполнила эскадру. ",
            scene = scenes[5],
            options = listOf()
        ),
        ...
        73 to Dialogue(
            text = "Неопытные наблюдатели, страх и последующая паника привели к тому, что эскадра расстреливала рыбацкие параходики... Более того, когда часть кораблей включила боевое освещение, " +
